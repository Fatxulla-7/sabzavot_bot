...
# ===================== SOZLAMALAR =====================
# Render.com da Environment Variables dan o'qiladi
# Lokal testda .env yoki to'g'ridan-to'g'ri kiriting
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8687459331:AAFrUqytKphv7eT6P7bDe70CW2ltv4whMqU")
ADMIN_IDS = list(map(int, os.environ.get("ADMIN_IDS", "7461041638").split(",")))
